    ...
    if ($msg = "true") {
        ...
        if($result !== "Can't get data")
        {
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                $GLOBALS['output'] .= "<td><a title='Edit' class='btn btn-success btn-circle' href='useraction.php?id=" . $row['loginId'] ."&wtd=edit'"."><i class='fa fa-pencil'></i></a>&nbsp&nbsp</td>";
                //<a title='Delete' class='btn btn-danger btn-circle' href='useraction.php?id=" . $row['loginId'] ."&wtd=delete'"."><i class='fa fa-trash-o'></i></a>
                $GLOBALS['output'] .= "</tr>";
